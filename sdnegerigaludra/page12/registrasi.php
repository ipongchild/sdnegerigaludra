                            ...
                            <div class="col-lg-6 d-none d-lg-block">
                                ...
                                <div align="center">
                                    ...
                                    <div align="center">
                                        ...
                                        <small>Silahkan registrasi terlebih dahulu</small>
                                    </div>  
                                </div>     
                            </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username"
                                                id="username" placeholder="Username" class="form-control form-control-user">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">password</label>
                                            <input type="password" name="password"
                                                id="password" placeholder="password" class="form-control form-control-user">
                                        </div>
                                        <div class="form-group">
                                            <label for="password2">konfirmasi password</label>
                                            <input type="password" name="password2"
                                                id="password2" placeholder="konfirmasi password" class="form-control form-control-user">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" name="register" class="btn btn-grad btn-grad:hover"><strong class="text-white">Register</strong></button>
                                    </form>
                                </div>
                            </div>
                        </div>
